...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/accounts_logins_player.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/accounts_logins_player.exe: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/accounts_logins_player ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/AccountsDB.o: AccountsDB.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AccountsDB.o AccountsDB.cpp
...
${OBJECTDIR}/GamesDB.o: GamesDB.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GamesDB.o GamesDB.cpp
