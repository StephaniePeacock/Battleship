 ...
 * Purpose: GameBard Class Implementation
 */
...
void GameBoard::setBoard(int row,int col, const char c){
    board[row][col] = c;
}

void GameBoard::setShots(int row,int col, const char c){
    shots[row][col] = c;
}
...
bool GameBoard::isValidPlacement(int row, int col, int size, char direction) {
...
bool GameBoard::placeShip(int row, int col, int size, char direction, char shipType) {
...
void GameBoard::promptShipPlacement() {
...
void GameBoard::attackCell(int row, int col, GameBoard enemy) {
